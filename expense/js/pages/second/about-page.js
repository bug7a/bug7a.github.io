...
aboutPage.createInSecondViewAndShow = function() {

    secondView.removeOpenedPageInView()

    var box = secondView.getContainerBox()
    // Out of this function, use "aboutPage.box" for "box".
    aboutPage.box = box
    ...
    box.add(that)
    that.loadHTMLFileFromURL(lang.ABOUT_URL);
    ...
    print("Opened page id: " + aboutPage.ID)
}