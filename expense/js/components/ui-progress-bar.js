...
var createUIProgressBar = function(left = 0, top = 0, width = 300, height = 40) {
    ...
    var calculateProgressWidth = function($percentage) {

        $percentage = parseInt($percentage)
            
        var _progressWidth = parseInt((box.boxBack.width / 100) * $percentage)
    ...
    box.setProgressPercentage = function($percentage) {
        ...
        var _width = calculateProgressWidth($percentage)
...
UIProgressBar.calculatePercentage = function($width, $maxWidth) {
    ...
    var _percentage = parseInt(($width / $maxWidth) * 100)
