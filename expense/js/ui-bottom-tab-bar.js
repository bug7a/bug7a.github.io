...
bottomTabBar.create()
- create the object.
- left: 0, bottom:0, width: global.USED_WIDTH, height: 150
...
bottomTabBar.itemDataList = [
    { pageId: 1, title: lang.STATUS, iconFile: "images/ui-bottom-tab-bar/status.png" },
    { pageId: 2, title: lang.TRANSACTIONS, iconFile: "images/ui-bottom-tab-bar/transactions.png" },
    { pageId: 3, title: lang.SETTINGS, iconFile: "images/ui-bottom-tab-bar/settings.png" }
];
...
bottomTabBar.create = function() {
    ...
    bottomTabBar.WIDTH = global.USED_WIDTH;
    bottomTabBar.HEIGHT = 150;
    bottomTabBar.BACK_WIDTH = global.USED_WIDTH - 40;
    ...
    */
    ...
    that.load("images/ui-bottom-tab-bar/add-spending.png")
    that.space = 30
    that.opacity = 0.65
