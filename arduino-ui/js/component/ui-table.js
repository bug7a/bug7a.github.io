...
UITable.resetDefault = function() {
    ...
    UITable.default.iconFileDecrease = "js/component/ui-stepper/decrease.svg";
    UITable.default.iconFileIncrease = "js/component/ui-stepper/increase.svg";
...
UITable.create = function(parameters = {}) {
    ...
    const createTitleCell = (titleData, titleIndex) => {
        ...
        that.width = 12;
        that.height = 12;
        that.load("js/component/ui-table/asc.svg");
        that.center();
        that.top -= 3;
        ...
        that.width = 12;
        that.height = 12;
        that.load("js/component/ui-table/desc.svg");
        that.center();
        that.top += 3;
