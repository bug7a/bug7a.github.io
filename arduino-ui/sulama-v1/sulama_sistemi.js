...
window.onload = function() {
    ...
    */
    ...
    // Pompa 1 time description:
    settingsPage.lblDescPO1 = createLabel();
    box.darkModeUILeftTitle.add(that);
    that.right = 100;
    that.text = "2sn";
    that.onResize(function(self) {
        self.center("top");
    });
    settingsPage.lblDescPO1.opacity = 0;
    settingsPage.lblDescPO1.timer = null;
...
switch(uiToggle.toggleId) {
    ...
    case 'PO1':
        ...
        if(uiToggle.getValue()) {
            ...
            settingsPage.lblDescPO1.opacity = 1;
            settingsPage.lblDescPO1.text = "";
            settingsPage.lblDescPO1.value = 0;
            settingsPage.lblDescPO1.timer = setInterval(function() {
                settingsPage.lblDescPO1.value++;
                settingsPage.lblDescPO1.text = settingsPage.lblDescPO1.value + "sn";
            ...
            settingsPage.lblDescPO1.opacity = 0;
            settingsPage.lblDescPO1.timer = clearInterval(settingsPage.lblDescPO1.timer);
...
selectColorDialog.colorList = [0, 1, 2, 3, 4, 5, 6, 7, 8 ];
